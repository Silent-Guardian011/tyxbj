...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        ...
        classes = []
        try:
            rsp = self.fetch("https://996624.xyz/")
            if rsp and rsp.text:
                doc = pq(rsp.text)
    ...
    def categoryContent(self, tid, pg, filter, extend):
        ...
        videos = []
        try:
            url = f"https://996624.xyz/?s=Search..."
            rsp = self.fetch(url)
            if rsp and rsp.text:
                doc = pq(rsp.text)
    ...
    def detailContent(self, array):
        ...
        try:
            ...
            if aid.startswith('/'):
                play_url = "https://996624.yachts" + aid
            else:
                play_url = "https://996624.yachts/cn/home/web/" + aid
