...
function 解析CJCJ数据库($数据库, $文件路径) {
    ...
    try {
        ...
        $默认图片 = [
            'https://www.252035.xyz/imgs?t=' . time(),//这个是色图链接，可删除//这个是色图链接，可删除
